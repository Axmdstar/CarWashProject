    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="form-floating mb-3 flex-grow-1">
            <input value="<?php echo$UpdateData["CatName"]; ?>" type="Quantity" name="CategoryName" class="form-control" id="floatingInput" placeholder=""   required >
            <label for="floatingInput">Category Name </label> 
          </div>

          <div class="form-floating mb-3 flex-grow-1">
            <input value="<?php echo$UpdateData["CommisionRate"]; ?>" type="number" step="0.001" name="CommissionRate" class="form-control" id="floatingInput" placeholder=""  required>
